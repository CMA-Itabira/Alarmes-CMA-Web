...
def run():
    with sync_playwright() as p:
        ...
        # Passo 3: Verificar se o diálogo de configuração aparece
        ...
        try:
            ...
            caminho_destino = (
                "C:/Users/81057638/OneDrive - Vale S.A"
                "/PREDITIVA COMPLEXO ITABIRA - CMA 2.0/ITABIRA_CAUE.xlsx"
            )
